 ...
 */
final class Version20200916110420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE training_type (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, women_multipler DOUBLE PRECISION DEFAULT NULL, men_multipler DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE statistic (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', kcal INT DEFAULT NULL, max_height INT DEFAULT NULL, min_height INT DEFAULT NULL, max_speed DOUBLE PRECISION DEFAULT NULL, min_speed DOUBLE PRECISION DEFAULT NULL, avg_speed DOUBLE PRECISION DEFAULT NULL, duration VARCHAR(255) DEFAULT NULL, number_of_breaks INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE training (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', statistic_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', type_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_D5128A8F53B6268F (statistic_id), INDEX IDX_D5128A8FA76ED395 (user_id), INDEX IDX_D5128A8FC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE gps_log (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', training_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', longitude DOUBLE PRECISION NOT NULL, latitude DOUBLE PRECISION NOT NULL, speed DOUBLE PRECISION DEFAULT NULL, height DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, is_stop TINYINT(1) NOT NULL, is_paused TINYINT(1) NOT NULL, INDEX IDX_853D94E8BEFD98D1 (training_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE training ADD CONSTRAINT FK_D5128A8FC54C8C93 FOREIGN KEY (type_id) REFERENCES training_type (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE training DROP FOREIGN KEY FK_D5128A8FC54C8C93');
